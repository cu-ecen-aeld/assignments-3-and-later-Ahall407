...
void test_validate_my_username()
{
     ...
     */
    const char *username_test;
    const char *username_real;

    username_test = my_username();
    username_real = malloc_username_from_conf_file();

    TEST_ASSERT_EQUAL_STRING(username_real, username_test);
